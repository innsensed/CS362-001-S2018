...
public class Appt{
	...
	public void setValid() {
		...
		//	if (startDay < 1 || startDay > NumDaysInMonth)
			 if (startDay > 1 || startDay > NumDaysInMonth)  // BUG
    ...
    public boolean isRecurring() {
        ...
        // return getRecurNumber() == RECUR_NUMBER_NEVER; // perhaps a bug?
    }
    /** Gets recurIncrement */
    ...
    private String represntationApp(){
       ...
       // String represntationApp= printableHour +":"+ getStartMinute() + half; 
         String represntationApp= getStartMinute() +":"+ printableHour + half; // BUG
