...
//        testIsValid(testUrlPartsOptions, options);
   ...
   public void testIsValid(Object[] testObjects, long allowAllSchemes) {
      ...
      assertTrue(urlVal.isValid("http://www.google.com")); // verify isValid function working with a common URL
...
//		System.out.println(counter);
         ...
         if (printStatus) { // Never true
            if (printIndex) { // Never true
...
//      }
   ...
   Object[] testUrlParts = {testUrlScheme, testUrlAuthority, testUrlPort, testPath, testUrlQuery}; // these are the URLs we test
